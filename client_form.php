...
/**
 * Form class for the required client settings for the oauth2owncloud admin tool.
 *
...
class tool_oauth2owncloud_client_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'oauth', get_string('oauthlegend', 'tool_oauth2owncloud'));
        // Client ID.
        $mform->addElement('text', 'clientid', get_string('clientid', 'tool_oauth2owncloud'), array('size' => '64'));
        $mform->addRule('clientid', get_string('required'), 'required', null, 'client');
        $mform->addRule('clientid', get_string('err_alphanumeric', 'form'), 'alphanumeric', null, 'client');
